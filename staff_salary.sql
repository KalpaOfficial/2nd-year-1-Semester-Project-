...
CREATE TABLE `salary` (
  ...
  `pay_rate` decimal(10,2) NOT NULL DEFAULT '1000.00',
  ...
  CONSTRAINT `salary_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `users` (`employee_id`) ON DELETE CASCADE ON UPDATE CASCADE
